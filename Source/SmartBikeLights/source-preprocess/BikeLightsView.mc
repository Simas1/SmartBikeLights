...
// #if round || semioctagon
        // Keep the complete text block inside the curved display boundary.
        safeWidth = width * 0.7;
        safeHeight = height * 0.7;
// #endif
...
// #if touchScreen && dataField && !watchPanel
...
// #if dataField && touchScreen && !watchPanel
...
// #endif
        ...
        if (_isFullScreen && getPropertyValue("LightDiagnostics") == true) {
            LightDiagnostics.draw(dc, _lightNetwork, self, /* #if touchScreen */ true /* #else */ false /* #endif */, /* #if touchScreen && !watchPanel */ true /* #else */ false /* #endif */);
            return;
        }
...
// #if buttonPanel || touchScreen || watchPanel
...
// #endif
        ...
        var statusY = y + height - controlHeight - /* #if watchPanel */ 8 /* #else */ 2 /* #endif */;
