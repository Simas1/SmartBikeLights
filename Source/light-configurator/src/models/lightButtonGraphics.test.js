...
test.each(['moon', 'lightning', 'headlight-high', 'headlight-medium', 'headlight-low', 'taillight-high', 'taillight-medium', 'taillight-low'])('round-trips %s with and without ratings', icon => {
