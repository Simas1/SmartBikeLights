...
device="${1:-edge1040}"
case "$device" in
  edge1040|edge1050|edge850|edge550|edge840|edge540|fr965) ;;
  *) echo "Unsupported device: $device (expected edge1040, edge1050, edge850, edge550, edge840, edge540 or fr965)" >&2; exit 1 ;;
esac
